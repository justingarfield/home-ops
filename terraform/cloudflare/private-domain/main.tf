...
resource "cloudflare_record" "cname_dkim_selector1" {
  ...
  value   = "selector1-${local.domain_key}._domainkey.${local.onmicrosoft_domain_name}.onmicrosoft.com"
...
resource "cloudflare_record" "cname_dkim_selector2" {
  ...
  value   = "selector2-${local.domain_key}._domainkey.${local.onmicrosoft_domain_name}.onmicrosoft.com"
  comment = "Microsoft Exchange - DKIM"
  tags    = toset([
    "Production",
    "Microsoft Office 365",

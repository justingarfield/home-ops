...
New-TalosVM -VMNamePrefix k8s-wk -CPUCount 12 -StartupMemory 24GB -SwitchName StagingWk -TalosISOPath "C:\Users\jgarf\Downloads\talos-amd64-v1.4.4.iso" -NumberOfVMs 1 -VMDestinationBasePath 'F:\Hyper-V\Talos' -VHDSize 30GB -StorageVHDSize 50GB -MAC 001337133704

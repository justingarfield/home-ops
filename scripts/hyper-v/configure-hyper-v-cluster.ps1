function New-TalosVM {
  ...
  process {
    ...
    for ($i = 1; $i -le $NumberOfVMs; $i++) {
      ...
      Set-VM -VMName $VMName -ProcessorCount $CPUCount -CheckpointType Disabled
...
New-TalosVM -VMNamePrefix k8s-cp -CPUCount 4 -StartupMemory 8GB -SwitchName StagingCp -TalosISOPath "C:\Users\jgarf\Downloads\talos-amd64-v1.4.4.iso" -NumberOfVMs 1 -VMDestinationBasePath 'C:\Hyper-V\Talos' -VHDSize 20GB -MAC 001337133701
# New-TalosVM -VMNamePrefix k8s-cp -CPUCount 4 -StartupMemory 8GB -SwitchName StagingCp -TalosISOPath "C:\Users\jgarf\Downloads\talos-amd64-v1.4.4.iso" -NumberOfVMs 1 -VMDestinationBasePath 'C:\Hyper-V\Talos' -VHDSize 20GB -MAC 001337133702
# New-TalosVM -VMNamePrefix k8s-cp -CPUCount 4 -StartupMemory 8GB -SwitchName StagingCp -TalosISOPath "C:\Users\jgarf\Downloads\talos-amd64-v1.4.4.iso" -NumberOfVMs 1 -VMDestinationBasePath 'C:\Hyper-V\Talos' -VHDSize 20GB -MAC 001337133703
New-TalosVM -VMNamePrefix k8s-wk -CPUCount 8 -StartupMemory 12GB -SwitchName StagingWk -TalosISOPath "C:\Users\jgarf\Downloads\talos-amd64-v1.4.4.iso" -NumberOfVMs 1 -VMDestinationBasePath 'F:\Hyper-V\Talos' -VHDSize 50GB -StorageVHDSize 100GB -MAC 001337133704
# New-TalosVM -VMNamePrefix k8s-wk -CPUCount 4 -StartupMemory 8GB -SwitchName StagingWk -TalosISOPath "C:\Users\jgarf\Downloads\talos-amd64-v1.4.4.iso" -NumberOfVMs 1 -VMDestinationBasePath 'F:\Hyper-V\Talos' -VHDSize 30GB -MAC 001337133705

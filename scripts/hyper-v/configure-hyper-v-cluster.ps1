...
New-TalosVM -VMNamePrefix k8s-wk -CPUCount 8 -StartupMemory 24GB -SwitchName StagingWk -TalosISOPath "C:\Users\jgarf\Downloads\talos-amd64-v1.4.4.iso" -NumberOfVMs 1 -VMDestinationBasePath 'F:\Hyper-V\Talos' -VHDSize 50GB -StorageVHDSize 100GB -MAC 001337133704
